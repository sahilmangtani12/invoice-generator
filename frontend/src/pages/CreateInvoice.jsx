...
} // it will return the image coming from the server side  
...
//computes the total for subtotal,tax, and total value
  ...
  async function handleSave() {
    ...
    try {
      ...
      const prepared = {
        ...
        notes: invoice.notes || "",
        localId: invoice.id,
      }; //things that will be saved in backend DB
