    ...
    // to remove the profile the image saved in the uploads will get deleted
      function handleClearProfile() {
        ...
        {!isSignedIn && (
            ...
            Please sign in to access your business profile.
            </div>
        )}
        </div>
        <form
                ...
                <div>
                    ...
                    <div className={businessProfileStyles.taxContainer}>
                        ...
                        <div className="flex items-center gap-3">
                            <input type="number" min="0" max="100" steps="0.1" className={businessProfileStyles.taxInput}
                            value={meta.defaultTaxPercent ?? 18} onChange={(e) =>
                            updateMeta (
                                "defaultTaxPercent", Number(e.target.value || 0)
                            )
                            }
                            />
                        ...
                        This tax rate will prefill in new invoices. 
                        You can adjust it per invoice as needed.
                        </p>
                    </div>
                </div>
            </div>
